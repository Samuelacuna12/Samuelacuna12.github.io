/* INVICTO OPS v51 · versión canónica */
(function(){
  const VERSION='51.0';
  ...
  if(!document.querySelector('script[data-v51-performance]')){const s=document.createElement('script');s.src='ops-v51-performance-sync.js?v=51.0';s.dataset.v51Performance='1';document.body.appendChild(s)}
