/* INVICTO OPS v51.5 · versión canónica */
(function(){
  const VERSION='51.5';
  ...
  if(!document.querySelector('script[data-v51-performance]')){const s=document.createElement('script');s.src='ops-v51-performance-sync.js?v=51.5';s.dataset.v51Performance='1';document.body.appendChild(s)}
  setTimeout(apply,120);setTimeout(apply,1200);setTimeout(apply,2200);
  console.info('INVICTO OPS v'+VERSION+' · fuente única + Inicio moderno premium');
})();